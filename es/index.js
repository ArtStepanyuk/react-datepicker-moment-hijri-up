...
var Day = function (_React$Component) {
  ...
  Day.prototype.render = function render() {
    return React.createElement(
      ...
      formatDay(getDate(this.props.day, this.props.calendar), this.props.calendar)
    );
  };
...
var Week = function (_React$Component) {
  ...
  function Week() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.handleDayClick = function (day, event) {
      ...
      return getWeek(startOfWeek, _this.props.calendar);
    }, _this.renderDays = function () {
      var startOfWeek = getStartOfWeek(cloneDate(_this.props.day), _this.props.calendar);
      var days = [];
      ...
      return days.concat([0, 1, 2, 3, 4, 5, 6].map(function (offset) {
        var day = addDays(cloneDate(startOfWeek), offset, _this.props.calendar);
...
var Month = function (_React$Component) {
  ...
  function Month() {
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.handleDayClick = function (day, event) {
      ...
      var endOfWeek = addDays(cloneDate(startOfWeek), 6, _this.props.calendar);
      return isSameMonth(startOfWeek, day, _this.props.calendar) || isSameMonth(endOfWeek, day, _this.props.calendar);
    }, _this.renderWeeks = function () {
      var weeks = [];
      var isFixedHeight = _this.props.fixedHeight;
      var currentWeekStart = getStartOfWeek(getStartOfMonth(cloneDate(_this.props.day), _this.props.calendar), _this.props.calendar);
      var i = 0;
      ...
      while (true) {
        weeks.push(React.createElement(Week, {
          ...
          month: getMonth(_this.props.day, _this.props.calendar),
        ...
        i++;
        currentWeekStart = addWeeks(cloneDate(currentWeekStart), 1, _this.props.calendar);
    ...
    return _ret = (_temp = (_this = possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.handleClick = function (time) {
      ...
      for (var i = 0; i < multiplier; i++) {
        ...
        if (_this.props.injectTimes) {
          var timeToInject = timeToInjectAfter(base, currentTime, i, intervals, _this.props.injectTimes);
          if (timeToInject) {
...
var Calendar = function (_React$Component) {
  ...
  function Calendar(props) {
    ...
    _this.increaseMonth = function () {
      _this.setState({
        date: addMonths(cloneDate(_this.state.date), 1, _this.props.calendar)
      }, function () {
    ...
    _this.decreaseMonth = function () {
      _this.setState({
        date: subtractMonths(cloneDate(_this.state.date), 1, _this.props.calendar)
      }, function () {
        return _this.handleMonthChange(_this.state.date);
      });
    };
    ...
    _this.changeYear = function (year) {
      _this.setState({
        date: setYear(cloneDate(_this.state.date), year, _this.props.calendar)
      }, function () {
    ...
    _this.changeMonth = function (month) {
      _this.setState({
        date: setMonth(cloneDate(_this.state.date), month, _this.props.calendar)
      }, function () {
        return _this.handleMonthChange(_this.state.date);
      });
    };
    ...
    _this.changeMonthYear = function (monthYear) {
      _this.setState({
        date: setYear(setMonth(cloneDate(_this.state.date), getMonth(monthYear), _this.props.calendar), getYear(monthYear, _this.props.calendar), _this.props.calendar)
      }, function () {
    ...
    _this.header = function () {
      ...
      var startOfWeek = getStartOfWeek(cloneDate(date), _this.props.calendar);
      var dayNames = [];
    ...
    _this.renderCurrentMonth = function () {
      ...
      return React.createElement(
        "div",
        { className: classes.join(" ") },
        formatDate(date, _this.props.dateFormat, _this.props.calendar)
      );
    };
    ...
    _this.renderYearDropdown = function () {
      ...
      return React.createElement(YearDropdown, {
        ...
        minDate: _this.props.minDate,
        maxDate: _this.props.maxDate,
        year: getYear(_this.state.date, _this.props.calendar),
        scrollableYearDropdown: _this.props.scrollableYearDropdown,
        yearDropdownItemNumber: _this.props.yearDropdownItemNumber,
        calendar: _this.props.calendar
      });
    ...
    _this.renderMonthDropdown = function () {
      ...
      return React.createElement(MonthDropdown, {
        ...
        month: getMonth(_this.state.date, _this.props.calendar),
      ...
      return React.createElement(
        "div",
        {
          ...
          onClick: function onClick(e) {
            return _this.props.onSelect(getStartOfDate(now(_this.props.utcOffset), _this.props.calendar), e);
          }
        },
    ...
    _this.renderMonths = function () {
      ...
      for (var i = 0; i < _this.props.monthsShown; ++i) {
        var monthDate = addMonths(cloneDate(_this.state.date), i, _this.props.calendar);
...
var DatePicker = function (_React$Component) {
  ...
  function DatePicker(props) {
    ...
    _this.renderDateInput = function () {
      ...
      var inputValue = typeof _this.props.value === "string" ? _this.props.value : typeof _this.state.inputValue === "string" ? _this.state.inputValue : safeDateFormat(_this.props.selected, _this.props, _this.props.calendar);
